            ...
            <DropdownMenuTrigger>
              <div
                ...
                style={{
                  ...
                  'background-image': `url(${user() ?? 'https://thicc-uwu.mywaifulist.moe/waifus/satoru-gojo-sorcery-fight/bOnNB0cwHheCCRGzjHLSolqabo41HxX9Wv33kfW7.jpg?class=thumbnail'})`,
                }}
              />
            </DropdownMenuTrigger>
